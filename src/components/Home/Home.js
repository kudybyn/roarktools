  ...
  return (
    <MenuLayout>
      <div className="w-full min-h-[100vh]">
        ...
        <div className="relative z-10"><h1 className="font-bold text-white text-[42px] md:text-[62px] text-center leading-[5rem] uppercase">ROARK TOOLS <br/> {t('homepage.title')}</h1></div>
