    ...
    <div className='bg-black fixed w-full'>
      <div className='w-full flex container mx-auto items-center justify-between py-5'>
        ...
        <div className='group mr-6'>
          <a
            className='flex gap-1 items-center  text-white font-normal group-hover:text-redColor ease-out transition-all'
        ...
        <div className='flex gap-6'>
              ...
              return (
                <div
                  ...
                  className={clsx(
                    ...
                    'w-[34px] hover:scale-150 transition-all ease-out cursor-pointer hover:bg-white hover:text-redColor hover:border-redColor h-[34px] flex items-center justify-center border  uppercase font-normal'
                  )}
                >
                  {language}
                </div>
          ...
          <div className='flex gap-1'>
            <a
              ...
              className={clsx(
                'w-[34px] hover:scale-150 transition-all ease-out transition-all group cursor-pointer hover:bg-white hover:text-redColor hover:border-redColor h-[34px] flex items-center justify-center border border-white text-white uppercase font-normal'
              )}
            >
              <svg
                xmlns='http://www.w3.org/2000/svg'
